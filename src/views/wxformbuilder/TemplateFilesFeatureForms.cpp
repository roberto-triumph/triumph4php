...
BEGIN_EVENT_TABLE( TemplateFilesPanelGeneratedClass, wxPanel )
	...
	EVT_BUTTON( wxID_HELP, TemplateFilesPanelGeneratedClass::_wxFB_OnHelpButton )
...
TemplateFilesPanelGeneratedClass::TemplateFilesPanelGeneratedClass( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	MiddleSizer->Add( HelpButton, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );

	CurrentButton = new wxButton( this, ID_CURRENTBUTTON, _("Current"), wxDefaultPosition, wxDefaultSize, 0 );
	MiddleSizer->Add( CurrentButton, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
