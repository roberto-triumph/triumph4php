...
class FindInFilesDialogGeneratedClass : public wxDialog 
{
	...
	public:
		...
		FindInFilesDialogGeneratedClass( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Find In Files"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 500,430 ), long style = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER );
