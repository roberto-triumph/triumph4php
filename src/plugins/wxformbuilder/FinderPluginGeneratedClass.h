...
#ifndef __FinderPluginGeneratedClass__
#define __FinderPluginGeneratedClass__
...
class ReplacePanelGeneratedClass : public wxPanel 
{
	...
	protected:
		enum
		{
			ID_FIND_REG_EX_HELP = 1000,
			ID_FINDTEXT,
			ID_REPLACE_REG_EX_HELP,
			ID_REPLACEWITHTEXT,
			ID_REPLACE_CLOSE,
			ID_WRAP,
		};
...
#endif //__FinderPluginGeneratedClass__
